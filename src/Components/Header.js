...
import Adroll_Header_Logo from '../img/adroll-logo-2x.png';
import RollWorks_Header_Logo from '../img/rollworks-logo-2x.png';
import RollWorks_Off_image from '../img/rollworks-logo-grayscale-2x.png';
import USA_Flag_Image from '../img/au.png';
    ...
    <nav id='site-switcher'>
        <div className='Logos-Div'>
            <ul>
                ...
                <li id='RollWorks_Off_Image_li'><a  className='logslinks' href="#readmore"><img src={RollWorks_Off_image} alt='RollWorlks' /></a></li>
            </ul>
        </div>
