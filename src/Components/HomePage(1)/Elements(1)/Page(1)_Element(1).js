...
import '../Styles(1)/Homepage-2Css.css';
import "../Styles(1)/SlickStyles/slick.css";

import Richi from '../img(1)/rich-sunski.png';
import Adam from '../img(1)/adam-teepublic.png';
import Hannah from '../img(1)/hannah-boomf.png';
